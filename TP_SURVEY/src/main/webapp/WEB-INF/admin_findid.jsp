	...
	<div class="w3-content w3-container w3-margin-top">
		<div class="w3-container w3-card-4">
			...
			<div>
				<p>
					<label>이름</label>
					<input class="w3-input" type="text" name="name" name="name" required>
				</p>
				<p>
					<label>Email</label>
				...
				<p class="w3-center">
					<button class="btn btn-primary confirm" role="button" aria-disabled="true" style="width:7cm; height:1cm;">찾기</button>
					
					<button class="btn btn-secondary" role="button" aria-disabled="true"  style="width:7cm; height:1cm;" >취소</button>
				</p>
			</div>
		</div>
	</div>
